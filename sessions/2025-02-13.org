...
#+tags: ovāda-pāṭimokkha, dhammapada
...
- cittajotanaṁ: The 'illumination' or 'brightening' of the mind. The radiant
mind (/pabhassara citta/) is obscured by defilements; purification restores its
natural clarity.
...
#+begin_quote
(DHPa) sacittapariyodapanan'ti pañcahi nīvaraṇehi attano cittassa vodāpanaṁ.
#+end_quote

**** adhicitte ca āyogo

AN 3.89 ([[https://suttacentral.net/an3.89/pli/ms][SC]], [[http://localhost:4848/suttas/an3.89/pli/ms?window_type=Sutta+Study][SSP]]): adhisīla, adhicitta (samādhi), adhipaññā
...
The Sanskritised form of the word being prātimoksa, this led to a
...
(masc.) (vinaya) 227 precepts for Buddhist monastics =[pa + ati + √mokkh + *a]= \\
pa- (prefix) forward; towards \\
mokkha: (masc.) release; freedom; √mokkh (be freed)

(VIN) pātimokkhan'ti ādim'etaṁ mukham'etaṁ pamukham'etaṁ kusalānaṁ dhammānaṁ. tena vuccati pātimokkhan'ti.

"Pātimokkha" means: it is the beginning, it is the entrance, it is the foremost
of all wholesome qualities. For that reason, it is called the Pātimokkha.

mukha: (nt) mouth; entrance; (adj) front; facing; foremost \\
