...
either right here & now, or in the next (lifetime), or following that. (Aj
Thanissaro)
#+end_quote

** AN 3.100: The result manifests in different strength, but same type
...
| *ayoghanahata* | /(adj)/ struck by an iron hammer; beaten with a sledgehammer  *[ayoghana + hata]*  /adj, comp/  |
